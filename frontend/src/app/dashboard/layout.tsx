...
export default function layout({
  ...
  return (
    <div
      className={cn(
        " flex w-screen h-screen flex-1 flex-col overflow-hidden rounded-md border border-neutral-200  bg-gray-100 md:flex-row dark:border-neutral-700 dark:bg-neutral-800",
        "h-screen "
      )}
    >
              ...
              <div className="mt-8 flex flex-col gap-2">
                ...
                <SidebarButton
                  link={{
                    ...
                    href: "#",
                    icon: (
                      <IconArrowLeft className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200 cursor-pointer" />
                    ),
                  }}
                ></SidebarButton>
              </div>
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="content absolute flex w-full justify-center items-center z--10 md:h-screen overflow-hidden">
